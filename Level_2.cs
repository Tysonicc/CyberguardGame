...
namespace CyberguardGame
{
    public partial class Level_2 : Form
    {
        ...
        /** Konstruktor formularzu Level_2 */
        public Level_2()
        {
        ...
        private void InitializeGame()
        {
            ...
            maze = new Maze(MazeLevel.Medium.Width, MazeLevel.Medium.Height);
            maze.GenerateMaze(MazeLevel.Medium.Grid, MazeLevel.Medium.EndPoint);

            /** Ustawienie gracza w punkcie startowym */
            player = new Player(MazeLevel.Medium.StartPoint.X, MazeLevel.Medium.StartPoint.Y);

            /** Tworzenie panelu do wyswietlania labiryntu */
            mazePanel = new BufforedPanel();
            mazePanel.Size = new Size(MazeLevel.Medium.Width * cellWidth + 50, MazeLevel.Medium.Height * cellHeight + 50);
            ...
            this.KeyDown += new KeyEventHandler(Level_2_KeyDown);
        ...
        private void StartResponseTimer()
        {
            ...
            responseTimer.Interval = 5000;                                              /** Ustawienie interwalu timera na 5 sekund */
        ...
        private void HandleResponse(bool isAgreed)
        {
            if (isAgreed)                                           /** Jesli uzytkownik sie zgodzi */
            {
                ...
                totalPoints -= 75;                                  /** Odejmowanie punktow z glownego licznika*/
        ...
        private void StartEmailTimer()
        {
            ...
            emailTimer.Interval = 12000;                                                /** Ustawienie interwalu timera na 10 sekund */
        ...
        private void StartSuspiciousLinkTimer()
        {
            ...
            suspiciousLinkTimer.Interval = 15000;
        ...
        private void StartSuspiciousLinkTimer_2()
        {
            ...
            suspiciousLinkTimer_2.Interval = 38000;
        ...
        private void StartNotificationTimer()
        {
            ...
            notificationTimer.Interval = 45000;
        ...
        private void EndGame()
        {
            ...
            btnContinue.Text = "START POZIOM 3";
